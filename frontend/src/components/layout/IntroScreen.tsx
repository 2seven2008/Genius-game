  ...
  return (
    <AnimatePresence>
      {phase !== "out" && (
        ...
        >
          {/* Invisible full word to anchor layout width */}
          <div className="relative flex items-center">
            <span className="font-display font-bold text-6xl tracking-tight invisible select-none">
              GENIUS
            </span>
            {/* Absolute overlay with animated letters */}
